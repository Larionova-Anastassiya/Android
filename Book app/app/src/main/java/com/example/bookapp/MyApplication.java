...
public class MyApplication extends Application {
    ...
    //created static method to convert timestamp to proper date format, so we can use it everywhere in project, no need to rewirte again
    ...
    public static void deleteBook(Context context, String bookId, String bookUrl, String bookTitle) {
        ...
        progressDialog.setMessage("Deleting "+bookTitle+" ..."); //e.g Deleting Book ABS ...
        progressDialog.show();
                        ...
                        reference.child(bookId)
                                ...
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        Toast.makeText(context, "Book  Deletes Successfully...", Toast.LENGTH_SHORT).show();
                                    }
                                })
