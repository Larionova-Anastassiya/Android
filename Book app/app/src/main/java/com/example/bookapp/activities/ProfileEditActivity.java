...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    private void uploadImage(){
        ...
        //image path and name, ue uid to replace previous
    ...
    private void updateProfile(String imageUrl){
        ...
        databaseReference.child(firebaseAuth.getUid())
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG, "onFailure: Failed to update db to "+e.getMessage());
                        progressDialog.dismiss();
                        Toast.makeText(ProfileEditActivity.this, "Failed to update db to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
