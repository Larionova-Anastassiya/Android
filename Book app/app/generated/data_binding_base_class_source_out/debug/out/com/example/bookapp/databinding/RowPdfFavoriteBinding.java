...
public final class RowPdfFavoriteBinding implements ViewBinding {
  @NonNull
  ...
  private RowPdfFavoriteBinding(@NonNull CardView rootView, @NonNull TextView categoryTv,
      ...
      @NonNull PDFView pdfView, @NonNull ProgressBar progressBar, @NonNull ImageButton removeFavBtn,
  ...
  @NonNull
  public static RowPdfFavoriteBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowPdfFavoriteBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_pdf_favorite, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowPdfFavoriteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.removeFavBtn;
      ImageButton removeFavBtn = ViewBindings.findChildViewById(rootView, id);
      ...
      return new RowPdfFavoriteBinding((CardView) rootView, categoryTv, dateTv, descriptionTv,
          pdfRl, pdfView, progressBar, removeFavBtn, sizeTv, titleTv);
    }
