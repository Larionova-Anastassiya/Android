...
public final class ActivityDashboardUserBinding implements ViewBinding {
  ...
  private ActivityDashboardUserBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageButton logoutBtn, @NonNull ImageButton profileBtn, @NonNull TextView subTitleTv,
      @NonNull TabLayout tabLayout, @NonNull TextView titleTv, @NonNull RelativeLayout toolbarRl,
  ...
  public static ActivityDashboardUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDashboardUserBinding((RelativeLayout) rootView, logoutBtn, profileBtn,
          subTitleTv, tabLayout, titleTv, toolbarRl, viewPager);
    }
