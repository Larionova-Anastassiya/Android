...
public final class ActivityPdfAddBinding implements ViewBinding {
  ...
  private ActivityPdfAddBinding(@NonNull RelativeLayout rootView, @NonNull ImageButton attachBtn,
      @NonNull ImageButton backBtn, @NonNull TextView categoryTv, @NonNull EditText descriptionEt,
      @NonNull TextInputLayout descriptionTil, @NonNull ImageView iconIv, @NonNull Button submitBtn,
  ...
  public static ActivityPdfAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPdfAddBinding((RelativeLayout) rootView, attachBtn, backBtn, categoryTv,
